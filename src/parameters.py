...
DILATION_RADIUS_PX = int((ROBOT_RADIUS_MM + 25) / MAP_WIDTH_MM * MAP_WIDTH_PX)
ROBOT_MASK_RADIUS_PX = int((ROBOT_RADIUS_MM + 20) / MAP_WIDTH_MM * MAP_WIDTH_PX)
TARGET_MASK_RADIUS_PX = int((TARGET_RADIUS_MM + 10) / MAP_WIDTH_MM * MAP_WIDTH_PX)
