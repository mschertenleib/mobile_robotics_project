...
def p_control(state, initial_state, goal_state, switch, previous_angle_error, previous_dist_error, sampling_time):
    ...
    u = [u_r, u_l];
    u_robot = [int(u[0]/0.4348), int(u[1]/0.4348)];

    return u_robot, switch, angle_error, dist_error
